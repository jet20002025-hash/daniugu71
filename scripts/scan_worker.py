...
def run_one():
    ...
    try:
        ...
        run_mode3_scan(
            ...
            use_71x_standard=(mode in ("mode3", "mode8", "mode9", "mode10", "mode11", "mode12", "mode90", "mode93", "mode底部大阳线", "mode平台突破首阳", "mode中位大阳线", "mode底部支撑", "mode最后震仓", "mode98", "mode32", "mode33", "mode34", "mode35", "mode36", "mode37", "mode38")),
