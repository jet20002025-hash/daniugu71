...
def run_one():
    ...
    try:
        ...
        run_mode3_scan(
            ...
            use_71x_standard=(mode in ("mode3", "mode8", "mode9", "mode10", "mode11", "mode12", "mode90", "mode93", "mode底部大阳线", "mode平台突破首阳", "mode中位大阳线", "mode底部支撑", "mode最后震仓", "mode98", "mode32", "mode33", "mode34", "mode35", "mode36", "mode37", "mode38", "mode39", "mode40")),
            use_mode8=False,  # 网络版 mode8 用 mode88 替代
            use_mode88=(mode == "mode8"),
            use_mode9=(mode == "mode9"),
            use_mode90=(mode == "mode90"),
            use_mode10=(mode == "mode10"),
            use_mode11=(mode == "mode11"),
            use_mode12=(mode == "mode12"),
            ...
            use_mode_bottom_support=(mode == "mode底部支撑"),
            use_mode_final_shakeout=(mode == "mode最后震仓"),
            use_mode98=(mode == "mode98"),
            use_mode32=(mode == "mode32"),
            use_mode33=(mode == "mode33"),
            use_mode34=(mode == "mode34"),
            use_mode35=(mode == "mode35"),
            use_mode36=(mode == "mode36"),
            use_mode37=(mode == "mode37"),
            use_mode38=(mode == "mode38"),
            use_mode39=(mode == "mode39"),
            use_mode40=(mode == "mode40"),
            user_id=user_id,
